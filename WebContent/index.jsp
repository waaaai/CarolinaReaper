...
<table>
	...
	<tr>
		<th>投稿締切日：</th>
		<td><input type="number" name="deadlineYearS" size="4" maxlength="4">年
			<input type="number" name="deadlineDayMonthS" size="2"maxlength="2">月
			<input type="number" name="deadlineDateS" size="2" maxlength="2">日
	</tr>
	<tr>
		<th>日程候補：</th>
		<td><input type="number" name="yearS" size="4" required maxlength="4">年
			<input type="number" name="monthS" size="2"required maxlength="2">月
			<input type="number" name="dayS" size="2" required maxlength="2">日
			<input type="number" name="hourS" size="2"required maxlength="2">時必須</td>
	</tr>
	<tr>
	...
	<th><input type="button" value="他の日程も選ぶ" onclick="Click_Sub()"></th>
		<td><div id="div1"><input type="number" name="yearS"required size="4" maxlength="4">年
			<input type="number" name="monthS" size="2"required maxlength="2">月
			<input type="number" name="dayS" size="2" required maxlength="2">日
			<input type="number" name="hourS" size="2"required maxlength="2">時必須</div><td>
	</tr>
	<tr>
	<script language="Javascript">
function Click_Sub() {
